...
////        Book uno = new Book();
////        uno.setTitulo("Biblia");
////        uno.setNumeroPaginas(100);
//
//        Book dos = bc.createBook("Las dos torres", 567, a, b);
//
//
//
//
//        uno.setUserLector(a);
//        dos.setUserEscritor(b);
//
//
//        listaLibrosEscritos.add(dos);
//        listaLibrosLeidos.add(uno);
//
//        a.setLibrosEscritos(listaLibrosEscritos);
//        b.setLibrosLeidos(listaLibrosLeidos);
////
////
//
//
...
//        uc.createUser(a);
////        dos.setUserLector(a);
////        listaLibrosLeidos.clear();
////        listaLibrosLeidos.add(dos);
////        a.setLibrosLeidos(listaLibrosLeidos);
////
//        uc.updateUser(a);


        //uc.librosLeidos(a);
//        cc.usuarioCreaUnComentario("muy buen libro", a, uno);
//        bc.listLibros();
//
//        cc.usuarioCreaUnaValoracion(2,a,dos);
